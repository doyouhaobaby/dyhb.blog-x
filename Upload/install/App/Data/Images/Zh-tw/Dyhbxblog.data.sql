...
(1, '歡迎使用DYHB.BLOG X！', 1332682510, 1332682510, '<p>DYHB.BLOG_X 2.0.1今天發布了，希望大家多多支持《<a href="http://bbs.doyouhaobaby.net">寂靜的論壇</a>》,關於DYHB.BLOG_X的使用大家也可以討論的。</p>', '本站原創', '', '', 1, 1, '', 4, 0, '', 0, 1, 0, 0, 0, 1, 1, 0, 0, 0, '', '', '<p>享受生活，感受非凡的DYHB.BLOG_X!</p>', '', 0, '127.0.0.1', 'a:4:{s:10:"comment_id";s:1:"1";s:15:"create_dateline";i:1319187928;s:9:"user_name";s:6:"跌名";s:7:"user_id";i:-1;}', '', '');

-- --------------------------------------------------------

--
-- 轉存表中的數據 `dyhbblogx_category`
--
...
(1, '我的心情', 1332682510, 1332682510, '', 0, '', 0, '', '', '我的個人心情，記錄生活的點點滴滴！', '', 1, 1, 1, '', '', '', 0, '', 0);

-- --------------------------------------------------------

--
-- 轉存表中的數據 `dyhbblogx_taotao`
--
...
(1, '讓心情更自然！<br />', 1332682510, 1, 0, 0, 0);

-- --------------------------------------------------------

--
-- 轉存表中的數據 `dyhbblogx_comment`
--
...
(1, 1332682510, 0, -1, 1, 'DYHB.BLOG X先生', '[emot]smile[/emot]歡迎加入DYHB.BLOG X 的大家庭。', '635750556@qq.com', 'http://doyouhaobaby.net', 1, '127.0.0.1', 0, 0, 0, 'blog', 1);

-- --------------------------------------------------------

--
-- 轉存表中的數據 `dyhbxblog_countcache`
--
...
(1, 'admin', 'admin後台管理', 1, '', 1, 0, 1, 0, 1, 0, 0),
(4, 'admin@index', '默認首頁', 1, '', 5, 1, 2, 0, 9, 0, 1323677150),
(2, 'admin@role', '角色管理', 1, '', 3, 1, 2, 0, 1, 0, 0),
(3, 'admin@user', '用戶管理', 1, '', 14, 1, 2, 0, 1, 0, 1323675420),
(7, 'admin@backup', '數據備份', 1, '', 1, 1, 2, 0, 4, 0, 1323677185),
(5, 'admin@group', '節點分組', 1, '', 2, 1, 2, 0, 1, 0, 0),
(6, 'admin@node', '節點管理', 1, '', 1, 1, 2, 0, 1, 0, 0),
(8, 'admin@badword', '詞語過濾', 1, '', 9, 1, 2, 0, 2, 0, 1323677322),
(9, 'admin@domain', '域名解析', 1, '', 5, 1, 2, 0, 4, 0, 1323677185),
(10, 'admin@option', '系統設置', 1, '', 2, 1, 2, 0, 3, 0, 1323675204),
(11, 'admin@mail', '郵件列表', 1, '', 2, 1, 2, 0, 4, 0, 1323677185),
(12, 'admin@blog', '文章管理', 1, '', 1, 1, 2, 0, 2, 0, 1323677322),
(13, 'admin@category', '文章分類', 1, '', 3, 1, 2, 0, 2, 0, 1323677322),
(14, 'admin@tag', '標籤管理', 1, '', 4, 1, 2, 0, 2, 0, 1323677322),
(15, 'admin@trackback', '引用管理', 1, '', 7, 1, 2, 0, 2, 0, 1323677322),
(16, 'admin@taotao', '微博管理', 1, '', 8, 1, 2, 0, 2, 0, 1323677322),
(17, 'admin@link', '友情銜接', 1, '', 1, 1, 2, 0, 7, 0, 1323677165),
(18, 'admin@upload', '媒體管理', 1, '', 1, 1, 2, 0, 6, 0, 1323676876),
(19, 'admin@uploadcategory', '媒體歸檔', 1, '', 2, 1, 2, 0, 6, 0, 1323676876),
(20, 'admin@theme', '主題管理', 1, '', 1, 1, 2, 0, 8, 0, 1323676976),
(21, 'admin@menusort', '導航排序', 1, '', 3, 1, 2, 0, 8, 0, 1323676976),
(22, 'admin@page', '頁面管理', 1, '', 2, 1, 2, 0, 2, 0, 1323677322),
(23, 'admin@widget', 'Widget', 1, '', 2, 1, 2, 0, 8, 0, 1323676976),
(24, 'admin@cache', '緩存服務', 1, '', 1, 1, 2, 0, 9, 1313915218, 1323677150),
(25, 'admin@relatedblog', '相關日誌', 1, '', 10, 1, 2, 0, 2, 1314541358, 1323677322),
(26, 'admin@blogtrackback', '日誌引用', 1, '', 11, 1, 2, 0, 2, 1314551188, 1323677322),
(27, 'admin@blogoption', '博客設置', 1, '', 1, 1, 2, 0, 3, 1314614998, 1323675204),
(28, 'admin@comment', '評論管理', 1, '', 5, 1, 2, 0, 2, 1315226863, 1323677322),
(29, 'admin@guestbook', '留言管理', 1, '', 6, 1, 2, 0, 2, 1315226899, 1323677322),
(30, 'admin@mp3player', 'Mp3播放器', 1, '', 4, 1, 2, 0, 6, 1315300307, 1323676876),
(31, 'admin@mp3playerdata', 'Mp3數據', 1, '', 3, 1, 2, 0, 6, 1315326653, 1323676876),
(32, 'admin@sound', '短消息聲音', 1, '', 4, 1, 2, 0, 3, 1317047900, 1323675204),
(33, 'admin@pm', '短消息', 1, '', 2, 1, 2, 0, 7, 1317151208, 1323677165),
(34, 'admin@emot', '表情管理', 1, '', 4, 1, 2, 0, 9, 1317201353, 1323677150),
(35, 'admin@searchindex', '搜索記錄', 1, '', 3, 1, 2, 0, 7, 1317271448, 1323677165),
(36, 'admin@frontendoptimization', '前端優化', 1, '', 4, 1, 2, 0, 7, 1317704033, 1323677165),
(37, 'admin@themeoption', '界面設置', 1, '', 4, 1, 2, 0, 8, 1317878590, 1323676976),
(38, 'admin@boarddata', '論壇統計', 1, '', 2, 1, 2, 0, 9, 1318625831, 1323677150),
(39, 'admin@boardcachedata', '緩存統計', 1, '', 3, 1, 2, 0, 9, 1318679544, 1323677150),
(40, 'admin@dataindex', '數據調用', 1, '', 3, 1, 2, 0, 4, 1318889948, 1323677185),
(41, 'admin@wapoption', 'Wap 設置', 1, '', 3, 1, 2, 0, 3, 1320429496, 1323675204),
(42, 'admin@loginlog', '登錄記錄', 1, '', 4, 1, 2, 0, 4, 1320681931, 1323677185),
...
('blog_description', 'PHP 開源博客'),
('blog_seo_descrition', '本站是DoYouHaoBaby-X Blog! 博客產品的官方交流站點。提供程序交流、產品擴展、技術支持等全方位服務。'),
('blog_seo_keywords', 'PHP 開源框架技術支持程序發布'),
...
('normal_menu_option', 'a:7:{s:3:"tag";a:7:{s:5:"title";s:9:"標籤雲";s:11:"description";s:54:"標籤雲在前台列出所有標籤，方便瀏覽。";s:4:"link";s:1:"#";s:5:"style";N;s:5:"color";i:0;s:6:"target";i:0;s:6:"system";i:1;}s:4:"link";a:7:{s:5:"title";s:12:"友情銜接";s:11:"description";s:42:"列出合作夥伴或者朋友的網站。";s:4:"link";s:1:"#";s:5:"style";N;s:5:"color";i:0;s:6:"target";i:0;s:6:"system";i:1;}s:6:"search";a:7:{s:5:"title";s:6:"搜索";s:11:"description";s:12:"搜索頁面";s:4:"link";s:1:"#";s:5:"style";N;s:5:"color";i:0;s:6:"target";i:0;s:6:"system";i:1;}s:6:"record";a:7:{s:5:"title";s:12:"搜索頁面";s:11:"description";s:30:"歸檔日誌，方便查找。";s:4:"link";s:1:"#";s:5:"style";N;s:5:"color";i:0;s:6:"target";i:0;s:6:"system";i:1;}s:6:"upload";a:7:{s:5:"title";s:12:"我的相冊";s:11:"description";s:24:"列出上傳的相片等";s:4:"link";s:1:"#";s:5:"style";N;s:5:"color";i:0;s:6:"target";i:0;s:6:"system";i:1;}s:6:"taotao";a:7:{s:5:"title";s:9:"微博客";s:11:"description";s:21:"放飛你的心聲。";s:4:"link";s:1:"#";s:5:"style";N;s:5:"color";i:0;s:6:"target";i:0;s:6:"system";i:1;}s:9:"guestbook";a:7:{s:5:"title";s:9:"留言板";s:11:"description";s:27:"方便訪客與你交流。";s:4:"link";s:1:"#";s:5:"style";N;s:5:"color";s:1:"0";s:6:"target";s:1:"0";s:6:"system";i:1;}}'),
('custom_normal_menu', 'a:0:{}'),
('blog_icp', ''),
('widget_blog_name', '博客形象'),
('calendar_widget_title', '日曆'),
('widget_link_name', '友情銜接'),
('widget_link_display_num', '5'),
('widget_recentpost_name', '最新日誌'),
('widget_recentpost_display_num', '5'),
('widget_randpost_name', '隨機日誌'),
...
('widget_category_name', '分類目錄'),
('widget_archive_name', '日誌歸檔'),
('widget_archive_display_num', '8'),
('widget_link_display_rand', '0'),
('widget_comment_name', '最新評論'),
...
('widget_hotpost_name', '熱門日誌'),
('widget_hotpost_display_num', '5'),
('widget_commentpost_name', '最受歡迎日誌'),
('widget_commentpost_display_num', '5'),
('widget_yearhotpost_name', '年度日誌排行'),
('widget_yearhotpost_display_num', '5'),
('widget_yearcommentpost_name', '年度最受歡迎日誌'),
('widget_yearcommentp_display_num', '5'),
('widget_monthhotpost_name', '當月排行日誌'),
('widget_monthhotpost_display_num', '5'),
('widget_monthcommentpost_name', '當月最受歡迎日誌'),
('widget_monthcommentp_display_num', '5'),
('widget_dayhotpost_name', '今日排行日誌'),
('widget_dayhotpost_display_num', '5'),
('widget_daycommentpost_name', '今日最受歡迎日誌'),
('widget_daycomment_display_num', '5'),
('widget_uploadcategory_name', '附件分類目錄'),
('widget_ucategory_display_num', '5'),
('widget_recentimage_name', '最新圖片'),
('widget_recentimage_display_num', '5'),
('widget_recentimage_autoplaytime', '3'),
('widget_theme_name', '主題切換'),
('widget_pagepost_display_num', '5'),
('widget_pagepost_name', '頁面'),
('widget_menu_name', '菜單'),
('widget_static_name', '博客統計'),
('today_visited_num', '1'),
('all_visited_num', '1'),
('widget_rss_name', 'Rss 訂閱'),
...
('widget_calendar_name', '日曆'),
('widget_lang_name', '國際化'),
...
('the_taotao_description', '我是滔滔心情的介紹，你可以在後台更改！'),
('the_tag_description', '我是標籤列表的的介紹，你可以在後台修改！'),
('the_search_description', '我是搜索文章的介紹'),
('the_404_description', '抱歉，您瀏覽的頁面未找到。也許搜索能幫到您。'),
('the_record_description', '我是日誌歸檔的介紹，你可以在後台修改！'),
('the_link_description', '我是友情銜接的介紹，你可以在後台修改！'),
('the_guestbook_description', '我是留言板的介紹，你有什麼問題需要請教嗎？'),
('display_blog_ucategory_list_num', '6'),
('the_uploadcateogory_description', '我是相冊描述，你可以在後台修改它。'),
('display_blog_upload_list_num', '15'),
('the_upload_description', '這是相片列表描述，你可以在後台更改。'),
...
('website_licence', '歡迎來到我們網站，這是我們的協議，請不要發布違法信息。'),
('the_register_description', '我是註冊描述，你可以在後台修改它'),
('audit_register', '0'),
('the_publish_description', '我是用戶投稿描述，你可以在後台進行編輯。'),
('website_publish_licence', '投稿許可協議，請遵循我們的投稿服務條款！'),
('display_blog_user_list_num', '15'),
('the_user_description', '這是用戶列表描述。'),
('display_blog_trackback_list_num', '15'),
('the_trackback_description', '這裡是引用描述...'),
('display_comments_list_num', '15'),
('the_comment_description', '評論描述......'),
...
('comment_spam_words', '虛擬主機,域名註冊,出租網,六合彩,鈴聲下載,手機鈴聲,和弦鈴聲,手機遊戲,免費鈴聲,彩鈴,網站建設,操你媽,rinima,日你媽,雞,操,雞吧,小姐,fuck,胡錦濤,溫家寶,胡溫,李洪志,法輪,民運,反共,專制,專政,獨裁,極權,中共,共產,共黨,六四,民主,人權,毛澤東,中國政府,中央政府,遊行示威,天安門,達賴,他媽的,我操,強姦,法輪'),
...
(1, '領導組', 0, 1, '我是領導組', NULL, 1295530584, 1307529261),
(2, '員工組', 0, 1, '我是員工組', NULL, 1295530598, 1307529240),
(3, '普通用戶', 0, 1, '我是普通用戶組', NULL, 1295581016, 1307529214);

-- --------------------------------------------------------

--
-- 轉存表中的數據 `dyhbxblog_user`
--
...
(1, 0, '0000-00-00', '', 4, '', '', '', '', '四川', '成都', 'admin', 'D先生', '3431cdc51b67a7749d2951e2d6715878', '127.0.0.1', 1319145823, '127.0.0.1', 0, '', '', 1304067406, 1319145823, 1, '38F222', 1, 21, '學生', 1, '游泳', '', '', 'doyouhaobaby', '', '', '', '', '', '', '', '', '', '', 1, 0);
