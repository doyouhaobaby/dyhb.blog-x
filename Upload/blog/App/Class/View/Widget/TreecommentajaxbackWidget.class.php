...
class TreecommentajaxbackWidget extends Widget{
	...
	public function render($arrData){
		...
		$arrData['floor']=CommentModel::getLevelByComment($arrData['comment']);
		$arrData['commentkey']=CommentModel::getCommentKeyByComment($arrData['comment']);
